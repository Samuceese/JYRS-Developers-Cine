...
class UserValidatorTest {
    ...
    fun validarAllCorrecto() {
        val user = Cliente("Juan", "Perez", "SnlScyowNTAyMDMwMw==", "adminJYRS@JYRS.es")
    ...
    fun validarNombre() {
        val user = Cliente("", "Perez", "SnlScyowNTAyMDMwMw==", "adminJYRS@JYRS.es")
    ...
    fun validarApellido() {
        val user = Cliente("Juan", "", "SnlScyowNTAyMDMwMw==", "adminJYRS@JYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
    ...
    fun validarEmailNoContieneArroba() {
        val user = Cliente("Juan", "Perez", "SnlScyowNTAyMDMwMw==", "adminJYRSJYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
    ...
    fun validarEmailVacio() {
        val user = Cliente("Juan", "Perez", "SnlScyowNTAyMDMwMw==", "")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "El correo electrónico no es correcto")
    }
    ...
    fun validarEmailNoContienePunto() {
        val user = Cliente("Juan", "Perez", "SnlScyowNTAyMDMwMw==", "adminJYRS@JYRSes")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "El correo electrónico no es correcto")
    }
    ...
    fun validarEmailNoSuperiorADosLetras() {
        val user = Cliente("Juan", "Perez", "SnlScyowNTAyMDMwMw==", "adminJYRS@JYRS.e")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "El correo electrónico no es correcto")
    }
    ...
    fun validarEmailSuperiorATresLetras() {
        val user = Cliente("Juan", "Perez", "SnlScyowNTAyMDMwMw==", "adminJYRS@JYRS.come")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "El correo electrónico no es correcto")
    }
    ...
    fun validarContrasenaVacia() {
        val user = Cliente("Juan", "Perez", "", "adminJYRS@JYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "La contraseña no es válida, debe tener 12 caracteres, contener al menos una mayúscula y una minúscula, un número y un caracter especial")
    }
    ...
    fun validarContrasenaSinCaracter() {
        val user = Cliente("Juan", "Perez", "SnlScyo5wNTty", "adminJYRS@JYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "La contraseña no es válida, debe tener 12 caracteres, contener al menos una mayúscula y una minúscula, un número y un caracter especial")
    }
    ...
    fun validarContrasenaMenor12() {
        val user = Cliente("Juan", "Perez", "SnlS7ow==", "adminJYRS@JYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "La contraseña no es válida, debe tener 12 caracteres, contener al menos una mayúscula y una minúscula, un número y un caracter especial")
    }
    ...
    fun validarContrasenaMayor12() {
        val user = Cliente("Juan", "Perez", "SnlScyowuduUGDHQU9iobfqh9==", "adminJYRS@JYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "La contraseña no es válida, debe tener 12 caracteres, contener al menos una mayúscula y una minúscula, un número y un caracter especial")
    }
    ...
    fun validarContrasenaSinNumero() {
        val user = Cliente("Juan", "Perez", "SnlScyowugt==", "adminJYRS@JYRS.es")
        val result = user.validate().error
        assertTrue(result is UserError.ValidateProblem)
        assertEquals(result.message, "La contraseña no es válida, debe tener 12 caracteres, contener al menos una mayúscula y una minúscula, un número y un caracter especial")
    }
