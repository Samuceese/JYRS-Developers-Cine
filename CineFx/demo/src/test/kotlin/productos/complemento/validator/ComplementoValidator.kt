...
class ComplementoValidator {
    ...
    fun casoOkFrutosSecos(){
        val complemento = ComplementoDto("COMIDA", "FRUTOS SECOS", "6.0")
    ...
    fun casoOkPatatas(){
        val complemento = ComplementoDto("COMIDA", "PATATAS", "6.0")
        val result = validateComplemento(complemento).isOk
        assertTrue(result)
    }
    ...
    fun casoOkPalomitas(){
        val complemento = ComplementoDto("COMIDA", "PALOMITAS", "6.0")
        val result = validateComplemento(complemento).isOk
        assertTrue(result)
    }
    @Test
    ...
    fun casoOkAgua(){
        val complemento = ComplementoDto("BEBIDA", "AGUA", "6.0")
        val result = validateComplemento(complemento).isOk
        assertTrue(result)
    }
    ...
    fun casoOkRefresco(){
        val complemento = ComplementoDto("BEBIDA", "REFRESCO", "6.0")
        val result = validateComplemento(complemento).isOk
        assertTrue(result)
    }
    ...
    fun casoIncorrectoTipoVacio(){
        val complemento = ComplementoDto("", "REFRESCO", "6.0")
    ...
    fun casoIncorrectoNombreVacio(){
        val complemento = ComplementoDto("BEBIDA", "", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoIncorrectoPrecioVacio(){
        val complemento = ComplementoDto("BEBIDA", "AGUA", "")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoIncorrectoMalTipo(){
        val complemento = ComplementoDto("flipendo", "AGUA", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoIncorrectoMalNombre(){
        val complemento = ComplementoDto("BEBIDA", "flipendo", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoIncorrectoMalPrecio(){
        val complemento = ComplementoDto("BEBIDA", "AGUA", "flipendo")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoConcordanciaComidaAgua(){
        val complemento = ComplementoDto("COMIDA", "AGUA", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoConcordanciaComidaRefresoc(){
        val complemento = ComplementoDto("COMIDA", "REFRESCO", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoConcordanciaBebidaPatatas(){
        val complemento = ComplementoDto("BEBIDA", "PATATAS", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoConcordanciaBebidaPalomitas(){
        val complemento = ComplementoDto("BEBIDA", "PALOMITAS", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
    ...
    fun casoConcordanciaBebidaFutosSecos(){
        val complemento = ComplementoDto("BEBIDA", "FRUTOS SECOS", "6.0")
        val result = validateComplemento(complemento).isErr
        assertTrue(result)
    }
